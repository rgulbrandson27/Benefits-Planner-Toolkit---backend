...
INSERT INTO employees (id, first_name, last_name, email, program_type, created_at, updated_at)
VALUES (27, 'Patricia', 'Planner', 'patricia.planner@ssabenefitshelp.org', 'TTW', NOW(), NOW())
    ON CONFLICT DO NOTHING;

-- Create two Beneficiaries
INSERT INTO clients (id, org_assigned_id, first_name, last_name, primary_worker_id, onset_date, application_date, entitlement_date, medicare_start_date, created_at, updated_at) VALUES
                                                                                                                                                                                     (1, 'AAA111', 'Betty', 'Beneficiary1', 27, '2023-10-19', '2024-11-10', '2023-11-01', '2025-11-01', NOW(), NOW()),
                                                                                                                                                                                     (2, 'BBB222', 'Bernard', 'Beneficiary2', 27, '2008-06-22', '2008-07-30', '2008-12-01', '2010-12-01', NOW(), NOW())
    ON CONFLICT DO NOTHING;

-- Betty - SCENARIO 1
INSERT INTO scenario (client_id, employee_id, scenario_start_year, description, status, created_at, updated_at) VALUES
    (1, 27, 2025, 'Resumed working with former employer in June 2025, working 20 hours/week at $16.00/hour for monthly average earnings of $1,686.00.', 'DRAFT', NOW(), NOW())
    ON CONFLICT DO NOTHING;
...
-- Betty - SCENARIO 2
INSERT INTO scenario (client_id, employee_id, scenario_start_year, description, status, created_at, updated_at) VALUES
    (1, 27, 2025, 'Returned to work part-time February 2025 (20 hrs/week at $16/hr), increased to full-time June 2025 (32 hrs/week at $18/hr).', 'DRAFT', NOW(), NOW())
    ON CONFLICT DO NOTHING;
